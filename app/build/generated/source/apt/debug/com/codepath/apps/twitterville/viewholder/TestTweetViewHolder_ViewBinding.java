...
public class TestTweetViewHolder_ViewBinding<T extends TestTweetViewHolder> implements Unbinder {
  protected T target;

  public TestTweetViewHolder_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
    ...
    target.vTweetName = finder.findOptionalViewAsType(source, R.id.tv_name, "field 'vTweetName'", TextView.class);
    target.vTweetBody = finder.findOptionalViewAsType(source, R.id.tv_body, "field 'vTweetBody'", TextView.class);
