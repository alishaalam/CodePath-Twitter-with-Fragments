...
/**
 * Created by alishaalam on 8/14/16.
 */
public class DirectMessagesFragment extends TweetListFragment {

    private static final String TAG = DirectMessagesFragment.class.getSimpleName();
    ...
    private void populateDirectMessages() {
        client.getDirectMessages(new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray jsonResponse) {
                ...
                parseJsonResponseToMessages(jsonResponse);
                Log.d(TAG, "Array populateDirectMessages Response: " + jsonResponse.toString());
            }
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                Log.d(TAG, "getTweetsForHomeTimeLine Failure: " + responseString);
                displayErrorResponse();
            }
        });
    }
    ...
    private void parseJsonResponseToMessages(JSONArray jsonResponse) {
        addAll(Messages.fromJsonArray(jsonResponse));
        displayTweets();
    }
